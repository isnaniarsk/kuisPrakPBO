...
public class View_Karyawan extends JFrame {
    JLabel lNIK = new JLabel(" NIK : ");
    JTextField tfNIK = new JTextField();
    JLabel lNamaKar = new JLabel(" Nama Karyawan : ");
    ...
    public View_Karyawan(){
        ...
        add(lNamaKar);
        lNamaKar.setBounds(10,60,300,20);
        add(tfNamaKar);
        tfNamaKar.setBounds(200,60,200,20);
        add(lJenisKel);
        lJenisKel.setBounds(10,90,300,20);
        add(rbPria);
        rbPria.setBounds(200,90,100,20);
        add(rbWanita);
        rbWanita.setBounds(320,90,100,20);
        add(lGol);
        lGol.setBounds(10,120,300,20);
        add(tfGol);
        tfGol.setBounds(200,120,200,20);
        add(lJabatan);
